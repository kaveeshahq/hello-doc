...
import { FaUserPlus, FaChevronDown, FaUser, FaCalendarAlt, FaSignOutAlt } from "react-icons/fa";
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <img 
                ...
                alt="Profile" 
              />
              <span className="hidden lg:block text-primary font-semibold">Profile</span>
              <FaChevronDown className={`w-3 h-3 text-primary transition-all duration-200 ${showDropdown ? 'rotate-180 text-secondary' : ''}`} />
            </div>
            
            {/* Enhanced Dropdown Menu */}
            <div className={`absolute top-full right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 z-20 transition-all duration-300 transform ${showDropdown ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible translate-y-2'}`}>
              {/* Arrow pointer */}
              ...
              <div className="p-2">
                ...
                <div className="mt-2 space-y-1">
                  ...
                  >
                    ...
                    <span className="text-primary font-medium group-hover/item:text-secondary">My Profile</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-primary font-medium group-hover/item:text-secondary">My Appointments</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-primary font-medium group-hover/item:text-red-500">Log Out</span>
                  </div>
                </div>
              </div>
            </div>
